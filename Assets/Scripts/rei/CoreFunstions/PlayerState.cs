...
namespace rei
{
    ...
    {
        [Header("Init")] public GameObject activeModel; //人物模型
        public Image damageImage; //受伤特效

        [Header("Character Stats")] public Attributes attributes; //人物属性（装备挂钩）
        public CharacterStats characterStats; //属性
        public WeaponStats weaponStats; //当前攻击属性
        ...
        public bool itemInput; //使用物体的输入

        public Vector3 rollDir; //翻滚方向 debug用
        ...
        public float toGround = 0.5f; //监测是否在地面的threshold
        public float rollSpeed = 1; //翻滚速度
        public float rollCost = 50f;
        public float parryOffset = 1f; //招架偏移
        public float backstabOffset = 1f; //被刺偏移

        [Header("States")] public bool run;
        ...
        public bool isTwoHanded;//双手共持
        public bool usingItem;
        public bool isBlocking;
        public bool isLeftHand;
        public bool canBeParried;//可以被弹反处决
        public bool parryIsOn; //正在招架反击
        public bool onEmpty; //空闲状态
        public bool hurt;//正在被打
        public bool isInvincible;//无敌！
        public bool damaged;//被打了，用于UI
        public bool isDead = false;


        [Header("Others")] public EnemyTarget lockOnTarget;
        public Transform lockOnTransform;

        [Header("Rolls")] public AnimationCurve roll_curve;
        public float rollDuration = 0.6f;

        [Header("Debug")] public float rbvz;
        public float rbvx;
        ...
        [HideInInspector] public PickableItemsManager pickManager;
        [HideInInspector] public AudioSource audio_source;
        [HideInInspector] public AudioClip audio_clip;
        ...
        {
            rbvz = rigid.velocity.z;//debug使用
            rbvx = rigid.velocity.x;//debug使用
            
            // onGround = OnGround();改到update中调用
            delta = d;
            isBlocking = false;
            ...
            if (!onEmpty && !canMove &&
                !canAttack) //Stop updating when all of the state managing variable is false (most likely the character is inAction)
                return;
        ...
        public void InteractLogic()
        {
            ...
            Interactions interaction =
                ResourceManager.instance.GetInteraction(pickManager.interactionCandidate.interactionId);
        ...
        public void DetectAction()
        {
            ...
            if (onEmpty == false && characterStats._stamina >=
        ...
        void HandleRolls()
        {
            ...
            isInvincible = true;
            isBlocking = false;
            characterStats._stamina -= rollCost;
        }
